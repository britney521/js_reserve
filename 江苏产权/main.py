...
for i in range(1,10):
    ...
    params = {
        'app': '05666ce3eef644079c38a49e56ea9e47',
        'sr': 'score desc',
        'pageId': 'afce95baf4ef4b1fa8d1ae8ee433222e',
        'ext': 'siteId:dd785e7f68ca42a89ae68ee255b0a990',
        'pNo': str(i),
        'q': '苏州',
    }

    response = session.get('https://www.jscq.com.cn/search/pcRender', params=params,  headers=headers)
    # print(response.cookies.get_dict())
    # print(response.text)
    jDwkDWjIm6GRO = '60cRNjg_b2SWvRi9DcyImMkX7XvTFSkXwmFrLAGaeH4PDKpk.XEaAN.C4zXzX4VQiidjl4GC2tSVAxKvnoRh6xOG'
    print(jDwkDWjIm6GRO)
    ojb_html = etree.HTML(response.text)
    contnt_data = ojb_html.xpath('//meta[@id="8WaRMCSEfLnj"]/@content')[0]
    func_code = ojb_html.xpath('//script[1]/text()')[0]
    script_src = ojb_html.xpath('//script[@src]/@src')[0]
    jssrc = 'https://www.jscq.com.cn' + script_src
    ...
    new_text = re.sub(
        ...
        f"cookie:'jDwkDWjIm6GRO={jDwkDWjIm6GRO}'",  # 替换为新的值
        new_text
    )
